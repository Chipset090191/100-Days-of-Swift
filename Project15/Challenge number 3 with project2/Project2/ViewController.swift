...
class ViewController: UIViewController {
    ...
    @IBAction func buttonTapped(_ sender: UIButton) {
        ...
        // MARK: Challenge 3.1 from Project 15
        ...
        if  countOfQuestions == 10 {
            ...
            // MARK: Challenge 3.2 from Project 15
            finalAC.addAction(UIAlertAction(title: "Click to start again!", style: .cancel, handler: { [weak self] action in
            ...
            // MARK: Challenge 3.3 from Project 15
            ac.addAction(UIAlertAction(title: "Continue", style: .default, handler: { [weak self] action in
                self?.askQuestion(action: action)
                sender.transform = .identity
            }))
