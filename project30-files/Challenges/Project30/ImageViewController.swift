...
class ImageViewController: UIViewController {
	...
	override func loadView() {
		...
		animTimer = Timer.scheduledTimer(withTimeInterval: 5, repeats: true) {  timer in
            ...
            self.imageView.transform = CGAffineTransform.identity  //  It represents the identity transformation matrix of our picture and then we scale it to 0.8
