...
class ViewController: UIViewController, WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        // MARK: Challenge 2.1
        let forward = UIBarButtonItem(title:"Forward ➡️", style: .done, target: webView, action: #selector(webView.goForward))
        let back = UIBarButtonItem(title: "Back ⬅️", style: .done, target: webView, action: #selector(webView.goBack))
        
        
        // prepare our progress of loadings
...
//        webView.load(URLRequest(url: url))
    ...
    // MARK: Challenge 1.2
    func AC_block_load() {
        let ac = UIAlertController(title: "Warning...!", message: "That is not allowed to get.", preferredStyle: .alert)
